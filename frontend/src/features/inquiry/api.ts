...
function asDraft(payload: InquiryDraft): InquiryDraft {
  ...
  return withFileUrls({
    ...
    supplier: {
      ...
      otherCategoryDetail: payload.supplier?.otherCategoryDetail ?? '',
      otherProductTypeDetail: payload.supplier?.otherProductTypeDetail ?? '',
    ...
    buyer: {
      ...
      otherProduct: Boolean(payload.buyer?.otherProduct),
      otherProductDetail: payload.buyer?.otherProductDetail ?? '',
    },
