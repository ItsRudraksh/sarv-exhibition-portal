export const copy = {
  ...
  supplier: {
    ...
    departmentsSubtitle:
      'Select one or more categories, or Other if your offering is not listed. We’ll show matching product types next.',
    ...
    productTypesSubtitle:
      'Choose subcategories that apply. Use Other and the description below if a product is not listed.',
    ...
    capabilityHint: 'A short description is enough. Include products that do not fit the listed categories.',
