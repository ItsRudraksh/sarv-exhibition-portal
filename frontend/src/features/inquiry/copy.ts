export const copy = {
  ...
  supplier: {
    ...
    departmentsTitle: 'Which categories do you want to work with?',
    departmentsSubtitle:
      'Describe what you can supply, or select categories. Either is enough to continue.',
    departmentsNote: 'The available categories are configured for this exhibition.',
    productTypesTitle: 'Which product types can you supply?',
    productTypesSubtitle:
      'Your selected categories stay checked. Choose product types under each, or add a description.',
    selectedCategories: 'From your categories',
    productTypesStep: 'Product types',
    smartDetailsTitle: 'Check your supplier details',
    smartDetailsSubtitle: 'Review what we have and add only what’s missing.',
    selectedTaxonomy: 'Selected taxonomy',
    ...
    websiteOrCatalogue:
      'Add a website or at least one supporting file — at least one is required. You can add both.',
    ...
    otherCategory: 'Other (not in this list)',
    otherProductType: 'Other / not in this list',
    capabilityLabel: 'What can you supply?',
    capabilityHint:
      'Optional if you selected from the list. A short description is enough when a product is not listed.',
    attachmentsTitle: 'Catalogues and supporting files',
    attachmentsHint: 'PDF or JPEG/PNG/WebP. Up to 10 files, 5 MB each.',
    attachmentsAdd: 'Add files',
    attachmentsRemove: 'Remove',
    attachmentsTooLarge: 'Each file must be 5 MB or smaller.',
    attachmentsTooMany: 'You can attach up to 10 files.',
  },
  buyer: {
    ...
    searchAreas: 'Search products (optional)',
    searchPlaceholder: 'Search Sarv and listed supplier products…',
    catalogueEmpty:
      'No buyer products listed yet. Stall staff: sync finished goods on /staff, or add offline/portal supplier products on /admin.',
    otherProduct: 'Other / not in this list',
    selectedGoods: 'Selected products (quantity required)',
    selectedBadge: 'Selected',
    removeGood: 'Remove',
    quantityLabel: 'Quantity',
    quantityPlaceholder: 'e.g. 500 kg',
    quantityHint: 'Required for each selected product.',
    exactProduct: 'I know the exact product',
    specsTitle: 'Add more details (optional)',
    specsHint: 'Pack size, standard, needed-by date, or notes.',
    teamFollowUp: 'Our team can follow up for anything else.',
    attachmentsTitle: 'Supporting files (optional)',
    attachmentsHint: 'PDF or JPEG/PNG/WebP. Up to 10 files, 5 MB each.',
  ...
  common: {
    ...
    editProductTypes: 'Edit product types',
    otherDetailsLabel: 'Describe Other',
    otherDetailsHint: 'Name the category or product that is not in the list.',
