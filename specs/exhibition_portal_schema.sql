-- Exhibition Portal PostgreSQL schema
...
--
-- Do not load this file as production V1. Scan-first mismatches (nullable
-- inquiries.route, nullable inquiry_parties.company_name_submitted) and the
-- applied POC subset live in backend/src/main/resources/db/migration/.
